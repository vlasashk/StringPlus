...
Own implementation of the string.h library in C programming language with some additions (with your own implementation of sprintf and sscanf functions and some additional functions from C#).
...
```
git clone https://github.com/vlasashk/StringPlus.git
cd StringPlus/
make
```
